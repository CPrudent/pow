...
BEGIN
    ...
    INSERT INTO fr.constant (usecase, key, value) VALUES
        ...
        , ('LAPOSTE_HOUSENUMBER_FAULT', 'BAD_NUMBER', '100')
        , ('LAPOSTE_HOUSENUMBER_FAULT', 'BAD_EXTENSION', '101')

        , ('LAPOSTE_COMPLEMENT_FAULT', 'BAD_SPACE', '200')
        , ('LAPOSTE_COMPLEMENT_FAULT', 'WITH_STREET_ERROR', '201')
    ;
END;
$proc$ LANGUAGE plpgsql;
