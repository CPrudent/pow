...
BEGIN
    ...
    -- join w/ bal_street
    CREATE INDEX IF NOT EXISTS ix_bal_housenumber_id_street ON fr.bal_housenumber (id_street);
END
...
BEGIN
    ...
    IF NOT EXISTS(
        ...
        ALTER TABLE fr.bal_housenumber
            ADD FOREIGN KEY (id_street) REFERENCES fr.bal_street (id)
