 ...
 * load w/ //BCAA/import-export/divers/import_wikipedia_commune_nouvelle.sh
 */
...
SELECT fr.get_date_wikipedia_municipality_event(minmax => TRUE)
 */
    ...
    ELSE
        IF check_exists AND information IS NULL THEN
            BEGIN
                ...
                INTO STRICT _exists
                FROM fr.territory
                WHERE nivgeo = 'COM' AND codgeo = code;
...
SELECT * FROM public.set_laposte_area_to_now();
...
BEGIN
    ...
    PERFORM fr.set_laposte_area_to_now();
