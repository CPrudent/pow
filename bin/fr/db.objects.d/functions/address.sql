...
SELECT public.drop_all_functions_if_exists('public', 'get_department_code_from_municipality_code');
CREATE OR REPLACE FUNCTION public.get_department_code_from_municipality_code(
