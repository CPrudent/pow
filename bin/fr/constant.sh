...
vacuum \
    --schema_name fr \
    --table_name constant,laposte_address_street_uniq,laposte_address_street_word_descriptor,laposte_address_street_keyword,laposte_address_street_kw_exception,laposte_address_fault_street \
    --mode ANALYZE || {
