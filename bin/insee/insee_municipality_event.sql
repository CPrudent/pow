/***
 * import INSEE municipality events
 */

TRUNCATE TABLE insee.municipality_event;
SELECT public.drop_table_indexes('insee', 'municipality_event');

INSERT INTO insee.municipality_event(
    mod
    , date_eff
    , typecom_av
    , com_av
...
UPDATE insee.municipality_event SET date_eff = TO_DATE('2014-07-01', 'YYYY-MM-DD')
...
UPDATE insee.municipality_event SET date_eff = TO_DATE('2016-01-01', 'YYYY-MM-DD')
